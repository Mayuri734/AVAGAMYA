...
def test_segment_clauses_noise_filtering():
    text = "Short text. Page 1. https://example.com. Charge is 5%. Normal text here too."
    clauses = SymbolicAnalysisEngine.segment_clauses(text)
...
def test_detect_financial_metrics():
    ...
    assert SymbolicAnalysisEngine.detect_financial_metrics("Interest rate is 12.5%.") == "12.5%"
