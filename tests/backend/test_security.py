...
async def test_pii_gate_blocking():
    ...
    with patch("main.extract_text_with_layout") as mock_extract, \
         patch("main.reconstruct_text_healer") as mock_healer:
        
        mock_extract.return_value = "This is a document with a credit card: 4111-1111-1111-1111. High risk!"
...
async def test_pii_compliance_logging():
    ...
    """
    with patch("main.extract_text_with_layout") as mock_extract, \
         patch("main.log_dpo_event") as mock_log:
